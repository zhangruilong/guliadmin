	                    ...
	                    items: [{
	        				...
	        				handler : function() {
	        					Ext.Msg.confirm('请确认', '<b>提示:</b>请确认要导出当前数据？', function(btn, text) {
	        						if (btn == 'yes') {
	        							window.location.href = basePath + Orderdaction + "?method=expAll&json="+queryjson+"&query="+Ext.getCmp("queryOrderdaction").getValue(); 
	        						}
	        					});
	        				}
	                    },{
    						...
    						handler : function() {
    							Ext.getCmp("Orderdorderdid").setEditable (true);
    							createQueryWindow("筛选", OrderddataForm, Orderdstore,Ext.getCmp("queryOrderdaction").getValue());
    						}
    					}]
	                }
	            }
