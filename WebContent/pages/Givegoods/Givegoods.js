	                    ...
	                    items: [{
	        				...
	        				handler : function() {
	        					Ext.Msg.confirm('请确认', '<b>提示:</b>请确认要导出当前数据？', function(btn, text) {
	        						if (btn == 'yes') {
	        							window.location.href = basePath + Givegoodsaction + "?method=expAll&json="+queryjson+"&query="+Ext.getCmp("queryGivegoodsaction").getValue(); 
	        						}
	        					});
	        				}
	                    },{
    						...
    						handler : function() {
    							Ext.getCmp("Givegoodsgivegoodsid").setEditable (true);
    							createQueryWindow("筛选", GivegoodsdataForm, Givegoodsstore,Ext.getCmp("queryGivegoodsaction").getValue());
    						}
    					}]
	                }
	            }
