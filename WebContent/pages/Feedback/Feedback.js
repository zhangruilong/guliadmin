	                    ...
	                    items: [{
	        				...
	        				handler : function() {
	        					Ext.Msg.confirm('请确认', '<b>提示:</b>请确认要导出当前数据？', function(btn, text) {
	        						if (btn == 'yes') {
	        							window.location.href = basePath + Feedbackaction + "?method=expAll&json="+queryjson+"&query="+Ext.getCmp("queryFeedbackaction").getValue(); 
	        						}
	        					});
	        				}
	                    },{
    						...
    						handler : function() {
    							Ext.getCmp("Feedbackfeedbackid").setEditable (true);
    							createQueryWindow("筛选", FeedbackdataForm, Feedbackstore,Ext.getCmp("queryFeedbackaction").getValue());
    						}
    					}]
	                }
	            }
