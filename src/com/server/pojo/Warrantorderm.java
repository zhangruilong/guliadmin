...
public class Warrantorderm
{
    ...
    * 下单金额
    */
   private Double ordermmoney;   
   /**
    * 实际金额
    */
   private Double ordermrightmoney;   
   /**
    * 支付方式
    */
   ...
   private String ordermprinttimes;   
	 ...
	 */
	public void setOrdermmoney(Double ordermmoney)
	{
	 ...
	 */
	public void setOrdermrightmoney(Double ordermrightmoney)
	{
	 ...
	 *获取"实际金额"属性
	 */
	public Double getOrdermrightmoney()
	{
